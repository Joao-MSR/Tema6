...
<body>
    ...
    if(isset($_POST['nome']) && isset($_POST['resposta1']) && isset($_POST['resposta2']) && isset($_POST['resposta3']) && isset($_POST['resposta4'])) {
        $nome = $_POST['nome'];
        ...
        echo "<p>Olá, $nome!</p>";
        echo "<p>Você acertou $acertos de 4 perguntas.</p>";
